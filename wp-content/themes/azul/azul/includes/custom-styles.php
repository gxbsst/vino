...
<?php
    ...
    $primary_color = get_option('primary_color', '#69b200');
    $secondary_color = get_option('secondary_color', '#ecf3e3');
...
?>
    ...
    #copyright-footer #copyright-footer-wrapper:before {
        background: <?php echo get_option('copyright_back_color', '#5c9b00'); ?>;
    }
    ...
    #copyright-footer, #site-footer, #site-footer a {
        color: <?php echo get_option('copyright_text_color', '#d7e4cb'); ?>;
    }
    ...
    .language-switcher-lans {
        background: <?php echo get_option('menu_hover_back', '#2a2a2a'); ?>;
    }
