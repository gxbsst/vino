...
function azul_register_required_plugins() {
    ...
    $plugins = array(
        array(
            'name' => 'WooSlider', 
            'slug' => 'wooslider', 
            'source' => 'http://anpsthemes.com/azul/wp-content/themes/azul/anps-framework/plugins/wooslider.zip', 
            'required' => false,
            'version' => '',
        ...
        array(
            'name' => 'revslider', 
            'slug' => 'revslider', 
            'source' => 'http://anpsthemes.com/azul/wp-content/themes/azul/anps-framework/plugins/revslider.zip', 
            'required' => true,
            'version' => '',
            'force_activation' => false, 
            'force_deactivation' => false, 
        ...
        array(
            ...
            'source' => 'http://anpsthemes.com/azul/wp-content/themes/azul/anps-framework/plugins/envato-wordpress-toolkit-master.zip', 
            'required' => true,
            'version' => '',
            'force_activation' => false, 
            'force_deactivation' => false, 
