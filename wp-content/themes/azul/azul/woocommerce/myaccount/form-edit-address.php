...
<div class="row">
	...
	<div class="span9">
		...
		<?php else : ?>
			...
			<form class="change-address" action="<?php echo esc_url( add_query_arg( 'address', $load_address, get_permalink( woocommerce_get_page_id('edit_address') ) ) ); ?>" method="post">
				...
				<p>
					<span class="btn"><input type="submit" name="save_address" value="<?php _e( 'Save Address', 'woocommerce' ); ?>" /></span>
