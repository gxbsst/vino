...
<form name="cart-form" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="checkout-button none button alt" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
...
<div class="cart-collaterals span3">
	...
	<?php if ( $woocommerce->cart->coupons_enabled() ) { ?>
		<div class="coupon">
			...
			<input placeholder="<?php _e("Enter coupon code", "azul"); ?>" type="text" class="input-text coupon-code" /> <button class="button cart-apply-coupon"></button>
