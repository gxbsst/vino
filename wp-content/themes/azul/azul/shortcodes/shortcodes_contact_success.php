...
<div id="readmore_1">
    ...
    <textarea name="success" id="success"></textarea><br>
</div>
    
</div>
<div class="submit-wrapper">
<input type="button" class="submit" value="Insert contact form" onclick="getValue()" />
</div>
<script>
function getValue() { 
    ...
    values = '[contact success="'+ success + '"][/contact]<br>';
