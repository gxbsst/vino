...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	if ( have_comments() ) :
		...
		echo '<p class="add_review"><a href="#review_form" class="btn inline show_review_form button" title="">' . __( 'Add Review', 'woocommerce' ) . '</a></p>';
	...
	$comment_form['comment_field'] .= '<span class="btn"><input type="submit" value="">submit</span>';
