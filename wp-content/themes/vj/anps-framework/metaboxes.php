...
add_action('add_meta_boxes', 'anps_content_add_custom_box');
add_action('save_post', 'anps_content_save_postdata');
...
function anps_content_add_custom_box() {
    ...
    foreach ($screens as $screen) {
        add_meta_box(
                'anps_breadcrumbs_sectionid', __('Side Content', 'azul'), 'display_meta_box_content', $screen
        );
    }
}
